        ...
        <Container>
          <Row className="align-items-center justify-content-lg-between justify-content-center">
            ...
            <Col lg={6}>
                ...
                Welcome to <span className="welcome_heading fs_7xl d-xxl-block">Small Arms Syndicate</span>
                </h2>
              ...
              <div className="text-center text-sm-start"><button className="ff_agnostic fw-normal py_14 px_20 fs_md btn_bg border-0 rounded-5 text-white mt-md-4 mt-sm-3 mt-2">
                Buy now
              </button></div>
            </Col>
          </Row>
